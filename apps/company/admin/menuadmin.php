...
if (isset($_GET['delete'])) {
    ...
    $redirect = "/admin/menuadmin?msg=deleted";
}
...
<div class="card" style="margin-bottom: 30px;">
    ...
    <form method="post" action="/admin/menuadmin" class="form-container">
        ...
        <div class="form-actions" style="margin-left: 180px; margin-top: 10px;">
            ...
            <?php if($edit): ?> 
                <a href="/admin/menuadmin" class="btn" style="background:#ccc; color:#333; text-decoration:none; padding:8px 15px; border-radius:4px;">Abbrechen</a> 
            <?php endif; ?>
        </div>
    </form>
</div>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td style="text-align:right;">
                    <a href="/admin/menuadmin?edit=<?= $m['id'] ?>" class="action-link edit-link">✎</a>
                    <a href="/admin/menuadmin?delete=<?= $m['id'] ?>" class="action-link delete-link" onclick="return confirm('Löschen?')">🗑</a>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
