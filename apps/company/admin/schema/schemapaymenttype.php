...
try {
    $pdo->exec("CREATE TABLE IF NOT EXISTS paymenttype (id SERIAL PRIMARY KEY);");
    ...
    $currentCols = $pdo->query("SELECT column_name FROM information_schema.columns WHERE table_name = 'paymenttype'")->fetchAll(PDO::FETCH_COLUMN);
