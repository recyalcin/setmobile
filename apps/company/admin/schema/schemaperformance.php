...
try {
    $pdo->exec("CREATE TABLE IF NOT EXISTS performance (id SERIAL PRIMARY KEY);");
    ...
    $currentCols = $pdo->query("SELECT column_name FROM information_schema.columns WHERE table_name = 'performance'")->fetchAll(PDO::FETCH_COLUMN);
