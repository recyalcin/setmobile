...
try {
    $pdo->exec("CREATE TABLE IF NOT EXISTS ticketstatus (id SERIAL PRIMARY KEY);");
    ...
    $currentCols = $pdo->query("SELECT column_name FROM information_schema.columns WHERE table_name = 'ticketstatus'")->fetchAll(PDO::FETCH_COLUMN);
