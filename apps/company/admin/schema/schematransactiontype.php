...
try {
    ...
    $pdo->exec("CREATE TABLE IF NOT EXISTS transactiontype (id SERIAL PRIMARY KEY);");
    ...
    $currentCols = $pdo->query("SELECT column_name FROM information_schema.columns WHERE table_name = 'transactiontype'")->fetchAll(PDO::FETCH_COLUMN);
