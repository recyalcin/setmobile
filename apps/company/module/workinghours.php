...
if (isset($_POST['save_workinghours']) || isset($_POST['duplicate_workinghours'])) {
    ...
    $fields = [
        ...
        'workendat', 'breakduration', 'startkm', 'endkm', 'hourstotal',
        'recordedat', 'note'
    ];
        ...
        <table class="data-table">
            ...
            <tbody>
                ...
                foreach ($list as $row): 
                    ...
                    $v04  = parseToFloat($row['startkm']);
                    $v20  = parseToFloat($row['endkm']);
        ...
        <div style="display: grid; grid-template-columns: 1.2fr 1.8fr; gap: 30px;">
            ...
            <div>
                ...
                <div class="form-row"><label>Spezial (0-4 / 20-6)</label>
                    <input type="number" step="0.01" name="startkm" style="width:48%; margin-right:2%;" value="<?= htmlspecialchars($edit['startkm'] ?? '') ?>">
                    <input type="number" step="0.01" name="endkm" style="width:48%;" value="<?= htmlspecialchars($edit['endkm'] ?? '') ?>">
                </div>
    ...
    <table class="data-table">
        ...
        <tbody>
            ...
            foreach ($list as $w): 
                ...
                $v04_l  = parseToFloat($w['startkm']);
                $v20_l  = parseToFloat($w['endkm']);
