...
try {
    ...
    $pdo->exec("CREATE TABLE IF NOT EXISTS cashboxtype (id INT AUTO_INCREMENT PRIMARY KEY) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;");
    ...
    $currentCols = $pdo->query("DESCRIBE cashboxtype")->fetchAll(PDO::FETCH_COLUMN);
    ...
    echo "<br><a href='/module/cashboxtype' class='btn save'>Zum Modul</a>";
