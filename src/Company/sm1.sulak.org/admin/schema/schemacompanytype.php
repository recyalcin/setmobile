...
try {
    $pdo->exec("CREATE TABLE IF NOT EXISTS companytype (id INT AUTO_INCREMENT PRIMARY KEY) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;");
    ...
    $currentCols = $pdo->query("DESCRIBE companytype")->fetchAll(PDO::FETCH_COLUMN);
