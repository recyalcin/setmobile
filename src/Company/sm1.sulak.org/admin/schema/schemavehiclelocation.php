...
try {
    $pdo->exec("CREATE TABLE IF NOT EXISTS vehiclelocation (id INT AUTO_INCREMENT PRIMARY KEY) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;");

    $columns = [
        'vehicleid'   => "INT DEFAULT NULL",
        'driverid'    => "INT DEFAULT NULL",
        'tripid'      => "INT DEFAULT NULL",
        'datetime'    => "DATETIME DEFAULT NULL", // DATETIME speichert Sekunden
    ...
    $currentCols = $pdo->query("DESCRIBE vehiclelocation")->fetchAll(PDO::FETCH_COLUMN);
