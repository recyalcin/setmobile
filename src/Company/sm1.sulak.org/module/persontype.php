...
if (isset($_POST['save_persontype'])) {
    ...
    if (!empty($id)) {
        ...
        $redirect = "/?route=module/persontype&edit=new&msg=updated&name=$nameParam";
    } else {
        // INSERT
        ...
        $pdo->prepare($sql)->execute($params);
        $redirect = "/?route=module/persontype&edit=new&msg=created&name=$nameParam";
    }
}
...
if (isset($_GET['delete'])) {
    ...
    $redirect = "/?route=module/persontype&edit=new&msg=deleted&name=$nameParam";
}
...
<div class="card" style="margin-bottom: 25px; border-left: 5px solid #3b82f6;">
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 15px;">
        ...
        <a href="/?route=module/persontype&edit=new" class="btn-action neu-bg">+ Neuer Typ</a>
    </div>

    <form method="post" action="/?route=module/persontype" class="form-container">
        ...
        <div style="display: flex; justify-content: space-between; align-items: center; margin-top: 20px; border-top: 1px solid #f1f5f9; padding-top: 15px;">
            <div><?php if(!empty($edit['id'])): ?><a href="/?route=module/persontype&delete=<?= $edit['id'] ?>" class="btn-action delete-bg" onclick="return confirm('Löschen?')">🗑 Löschen</a><?php endif; ?></div>
            <div style="display: flex; gap: 10px;">
                <a href="/?route=module/persontype&edit=new" class="btn-action cancel-bg">Abbrechen</a>
...
<div class="card search-card">
    <form method="get" action="/" style="display: flex; gap: 10px; width: 100%;">
        ...
        <?php if(!empty($searchTerm)): ?>
            <a href="/?route=module/persontype&edit=new" class="btn-action cancel-bg">✖ Filter löschen</a>
        <?php endif; ?>
    </form>
</div>
    ...
    <table class="data-table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td style="text-align:right;"><a href="/?route=module/persontype&edit=<?= $p['id'] ?>" class="edit-link">✎</a></td>
            </tr>
            <?php endforeach; ?>
            <?php if(empty($list)): ?>
